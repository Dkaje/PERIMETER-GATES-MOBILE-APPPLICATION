...
public class UpdatedMol extends ArrayAdapter<OrderMode> {
    public ArrayList<OrderMode> cartel;
    public ArrayList<OrderMode> orderModes;
    public FilteredItems filter;

    public UpdatedMol(Context context, int id, ArrayList<OrderMode> subjectArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = vi.inflate(R.layout.settled, null);
            ...
            holder.Named = convertView.findViewById(R.id.named);
            holder.Phone = convertView.findViewById(R.id.phoned);
            holder.Update = convertView.findViewById(R.id.updated);
            holder.Dated = convertView.findViewById(R.id.dated);

            convertView.setTag(holder);
// Named, Phone, Update, Dated
        } else {
        ...
        int pos = position + 1;
        holder.Mpesa.setText(+pos + ".  " + subject.getCategory());
        pos++;
        holder.Amount.setText(subject.getType());
        holder.Status.setText(subject.getQuantity() + "nits.");
        holder.Custm.setText(subject.getMaterial());
        holder.Datex.setText(subject.getCoating());
        holder.Named.setText(subject.getName());
        holder.Phone.setText(subject.getPhone());
        holder.Update.setText(subject.getBlacksmith());
        holder.Dated.setText(subject.getDate());
        return convertView;

    }

    public class ViewHolder {
        TextView Mpesa, Amount, Status, Custm, Datex, Named, Phone, Update, Dated;
    }
