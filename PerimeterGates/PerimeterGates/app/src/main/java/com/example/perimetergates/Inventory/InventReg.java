...
import com.example.perimetergates.BlackSmith.BlackReg;
...
public class InventReg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter1 = ArrayAdapter.createFromResource(this, R.array.Inve, android.R.layout.simple_spinner_item);
        ...
        btn.setOnClickListener(v -> {
            ...
            if (myName.isEmpty() || myLname.isEmpty() || myUser.isEmpty() || myEmail.isEmpty() || mypas.isEmpty() || myPhon.isEmpty()) {
                AlertDialog.Builder builder = new AlertDialog.Builder(InventReg.this);
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, TeaRoom.regSta,
                        response -> {
                            try {
                                ...
                                if (status==1) {
                                    Toast.makeText(InventReg.this, msg, Toast.LENGTH_LONG).show();
