...
public class BlacSess {
    private static final String preference = "Aloft";
    ...
    public BlacSess(Context mContext) {
     ...
     */
    //staff_id,fname,lname,username,contact,role,email,status,reg_date
    public void logBlack(String staff_id, String fname, String lname, String username, String contact, String role, String email,
     ...
     * @return user details
     */
    public StaffMod getBlackDetails() {
