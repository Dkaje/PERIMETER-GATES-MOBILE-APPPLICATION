...
public class RatedAda extends ArrayAdapter<PayerMode> {
    public ArrayList<PayerMode> MainList;
    public ArrayList<PayerMode> SubjectListTemp;
    public SubjectDataFilter subjectDataFilter;

    public RatedAda(Context context, int id, ArrayList<PayerMode> subjectArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.Hali.setText(subject.getCustomer());
        return convertView;
