...
public class BlackReg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("BlackSmith Registration");
        setContentView(R.layout.activity_black_reg);
        ...
        spnr = findViewById(R.id.role);
        btn = findViewById(R.id.btnRegister);
        ArrayAdapter<CharSequence> adapter1 = ArrayAdapter.createFromResource(this, R.array.Black, android.R.layout.simple_spinner_item);
        ...
        btn.setOnClickListener(v -> {
            ...
            if (myName.isEmpty() || myLname.isEmpty() || myUser.isEmpty() || myEmail.isEmpty() || mypas.isEmpty() || myPhon.isEmpty()) {
                AlertDialog.Builder builder = new AlertDialog.Builder(BlackReg.this);
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, TeaRoom.regSta,
                        response -> {
                            try {
                                ...
                                if (status==1) {
                                    Toast.makeText(BlackReg.this, msg, Toast.LENGTH_LONG).show();
