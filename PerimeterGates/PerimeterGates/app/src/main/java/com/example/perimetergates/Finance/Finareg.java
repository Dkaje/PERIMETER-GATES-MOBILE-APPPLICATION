...
public class Finareg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_finareg);
        ...
        btn.setOnClickListener(v -> {
            ...
            if (myName.isEmpty() || myLname.isEmpty() || myUser.isEmpty() || myEmail.isEmpty() || mypas.isEmpty() || myPhon.isEmpty()) {
                AlertDialog.Builder builder = new AlertDialog.Builder(Finareg.this);
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, TeaRoom.regSta,
                        response -> {
                            try {
                                ...
                                if (status==1) {
                                    Toast.makeText(Finareg.this, msg, Toast.LENGTH_LONG).show();
