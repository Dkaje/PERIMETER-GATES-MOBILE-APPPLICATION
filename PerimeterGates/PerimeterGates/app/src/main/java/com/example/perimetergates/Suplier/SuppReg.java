...
public class SuppReg extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Supplier Registration");
        ...
        btn.setOnClickListener(v -> {
            ...
            if (myName.isEmpty() || myLname.isEmpty() || myUser.isEmpty() || myEmail.isEmpty() || mypas.isEmpty() || myPhon.isEmpty()) {
                AlertDialog.Builder builder = new AlertDialog.Builder(SuppReg.this);
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, TeaRoom.regSup,
                        response -> {
                            try {
                                ...
                                if (status == 1) {
                                    Toast.makeText(SuppReg.this, msg, Toast.LENGTH_LONG).show();
