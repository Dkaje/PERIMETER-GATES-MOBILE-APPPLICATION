...
public class GateAda extends ArrayAdapter<GateMode> {
    public ArrayList<GateMode> MainList;
    public ArrayList<GateMode> SubjectListTemp;
    public SubjectDataFilter subjectDataFilter;

    public GateAda(Context context, int id, ArrayList<GateMode> subjectArrayList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = vi.inflate(R.layout.instilled, null);
