...
public class OrderApproved extends AppCompatActivity {
    ListView listView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Objects.requireNonNull(getSupportActionBar()).setTitle("Orders Approved");
        ...
        listView.setOnItemClickListener((parent, view, position, id) -> {
            ...
            showCategory(OrderApproved.this, position);
        });
        practical();
        button = findViewById(R.id.btnPrint);
    ...
    private void showCategory(OrderApproved orderYes, int position) {
    ...
    private void practical() {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, TeaRoom.orderHist,
                response -> {
                    try {
                        OrderMode subject;
                        ...
                        if (success == 1) {
                            ...
                            viewAda = new OrderUpp(OrderApproved.this, R.layout.minor, viewUsers);
