                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php $sql = "SELECT * from orders where mode='Shipped'";
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">KES <?php echo htmlentities($result->cost); ?></td>
                                            <td class="center"><?php echo htmlentities($result->quantity); ?> units</td>
                                            <td class="center">KES <?php echo htmlentities($result->unit); ?></td>
                                            ...
                                            <td class="center"><?php echo htmlentities($result->coating); ?></td>
                                            <td class="center"><?php echo htmlentities($result->dimension); ?></td>
                                            <td class="center"><?php echo htmlentities($result->set_date); ?></td>
                                            <td class="center"><?php echo htmlentities($result->finance); ?></td>
                                            <td class="center"><?php echo htmlentities($result->blacksmith); ?></td>
                                            <td class="center"><?php echo htmlentities($result->dispatcher); ?></td>
