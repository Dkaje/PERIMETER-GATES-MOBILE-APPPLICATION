                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php $sql = "SELECT * from customer where status=0";
                                            $query = $con->prepare($sql);
                                            $query->execute();
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                                ...
                                                <a href="custPending?idi=<?php echo htmlentities($result->cust_id); ?>"
                                                ...
                                                <a href="custPending?id=<?php echo htmlentities($result->cust_id); ?>"
