                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                                ...
                                                <a href="supApproved?idi=<?php echo htmlentities($result->supp_id); ?>"
                                                ...
                                                <!--<a href="supApproved?inid=?<php echo htmlentities($result->supp_id); ?>"
                                                    onclick="return confirm('Are you sure you want to block this Supplier?');">
                                                    <button class="
                                                    btn btn-danger"> Deactivate</button></a>-->
                                                <?php } else { ?>

                                                <a href="supApproved?id=<?php echo htmlentities($result->supp_id); ?>"
