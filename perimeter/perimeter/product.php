                                ...
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center"><img src="mobi/images/<?php echo htmlentities($result->image); ?>" height="80px" width="80px"/></td>
                                            <td class="center"><?php echo htmlentities($result->qty); ?> units</td>
                                            <td class="center"><?php echo htmlentities($result->quantity); ?> units</td>
                                            <td class="center"><?php $ori=$result->qty; $rem=$result->quantity; $yes=$ori-$rem;
                                            echo $yes; ?> units</td>
                                            <td class="center">KES <?php echo htmlentities($result->price); ?></td>
