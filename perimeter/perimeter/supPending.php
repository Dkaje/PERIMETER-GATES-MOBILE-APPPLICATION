                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php $sql = "SELECT * from supplier where status=0";
                                            $query = $con->prepare($sql);
                                            $query->execute();
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                                ...
                                                <a href="supPending?idi=<?php echo htmlentities($result->supp_id); ?>"
                                                ...
                                                <!--<a href="supPending?inid=?<php echo htmlentities($result->supp_id); ?>"
                                                    onclick="return confirm('Are you sure you want to block this Supplier?');">
                                                    <button class="
                                                    btn btn-danger"> Deactivate</button></a>-->
                                                <?php } else { ?>

                                                <a href="supPending?id=<?php echo htmlentities($result->supp_id); ?>"
