...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "SELECT * FROM payment where status='1' and mode='Shipped' and cust_id='$cust_id' and drive='Delivered' order by reg_date desc";
    ...
    if (mysqli_num_rows($response) > 0) {
        ...
        $results['trust'] = 0;
        $results['mine'] = "No Verified Record";
