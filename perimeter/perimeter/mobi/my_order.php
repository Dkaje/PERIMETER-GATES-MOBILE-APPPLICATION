...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (preg_match($caps, $mpesa)) {
        ...
        if (mysqli_num_rows($query) > 0) {
            ...
            $sql = "INSERT INTO orders(mpesa,amount,ship,cost,cust_id,name,phone,location,category,type,material,coating,dimension,quantity,unit,set_date,mode)
        VALUES('$mpesa','$amount','$ship','$cost','$cust_id','$name','$phone','$location','$category','$type','$material','$coating','$dimension','$quantity','$unit','$set_date','$mode')";
