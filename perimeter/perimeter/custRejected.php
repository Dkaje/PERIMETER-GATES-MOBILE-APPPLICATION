                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php $sql = "SELECT * from customer where status=2";
                                            $query = $con->prepare($sql);
                                            $query->execute();
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                                ...
                                                <a href="custRejected?idi=<?php echo htmlentities($result->cust_id); ?>"
                                                ...
                                                <a href="custRejected?id=<?php echo htmlentities($result->cust_id); ?>"
