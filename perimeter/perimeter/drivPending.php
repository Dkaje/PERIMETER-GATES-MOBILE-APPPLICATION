                        ...
                        <div class="panel-body">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php $sql = "SELECT * from driver where status=0";
                                            $query = $con->prepare($sql);
                                            $query->execute();
                                        ...
                                        <tr class="odd gradeX">
                                            ...
                                            <td class="center">
                                                ...
                                                <a href="drivPending?idi=<?php echo htmlentities($result->driver_id); ?>"
                                                ...
                                                <a href="drivPending?id=<?php echo htmlentities($result->driver_id); ?>"
